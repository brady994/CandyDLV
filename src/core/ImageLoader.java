...
public class ImageLoader {
	...
	static {
		try {
			...
			prova = new ImageIcon(ImageLoader.class.getClassLoader().getResource("assets/start.png"));
			...
			rollstart = new ImageIcon(ImageLoader.class.getClassLoader().getResource("assets/rollstart.png"));
	...
	public static Icon getRollstart() {
		return rollstart;
	}
