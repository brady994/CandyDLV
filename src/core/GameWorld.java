					...
					if (candies[i][j].getType() == candies[i][j + 1].getType()
						...
						if (i < rowS - 1 && j > 0) {
							if (candies[i][j].getType() == candies[i + 1][j - 1].getType()
								...
								// ricordiamoci che la caramelle � in pos
								// i+1,j-1;
				...
				if (j < colS - 3) {
					if (candies[i][j].getType() == candies[i][j + 1].getType()
						...
						if (candies[i][j].getType() == candies[i][j + 3].getType()
							...
							// ricordiamoci che la caramella � in pos i;j+3;
						...
						if (j >= 2
							...
							// ricordiamo che la caramella � in pos i;j-2;
				...
				if (j < colS - 3 && i > 0) {
					if (candies[j][i].getType() == candies[j + 1][i].getType()
						...
						if (candies[j][i].getType() == candies[j + 3][i].getType()
							...
							// ricordiamoci che la caramella � in pos j+3;i;
					...
					if (candies[j][i].getType() == candies[j + 1][i].getType()
						...
						if (j >= 2) {
							if (candies[j][i].getType() == candies[j - 2][i].getType()
								...
								// ricordiamoci che la caramella � in pos j-2;i
				...
				if (j < colS - 2) {
					if (candies[i][j].getType() == candies[i][j + 2].getType()
						...
						if (i > 0
							...
							// ricordiamoci che la caramella � in pos i-1;j+1
							tmpMovable.add(new Cell(i - 1, j + 1, candies[i - 1][j + 1]));
				...
				if (j < colS - 2) {
					if (candies[j][i].getType() == candies[j + 2][i].getType()
						...
						if (i < rowS - 1
							...
							// ricordiamoci che la caramella � in pos j+1;i+1;
							tmpMovable.add(new Cell(j + 1, i + 1, candies[j + 1][i + 1]));
						...
						/* mod -1 */if (j < colS
							...
							// ricordiamo che la caramella � in pos j+1;i-1;
							tmpMovable.add(new Cell(j + 1, i - 1, candies[j + 1][i - 1]));
